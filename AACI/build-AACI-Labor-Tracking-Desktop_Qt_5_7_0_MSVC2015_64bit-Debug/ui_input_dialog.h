...
public:
    ...
    {
        Input_Dialog->setWindowTitle(QApplication::translate("Input_Dialog", "Dialog", 0));
        Employee_Name_Label->setText(QApplication::translate("Input_Dialog", "Full Name:", 0));
        Employee_Pin_Label->setText(QApplication::translate("Input_Dialog", "PIN(4-digits):", 0));
        Employee_Wage_Label->setText(QApplication::translate("Input_Dialog", "Wage:", 0));
        Employee_Admin_CheckBox->setText(QApplication::translate("Input_Dialog", "Admin", 0));
        Employee_Finished->setText(QApplication::translate("Input_Dialog", "Finished", 0));
        Employee_Cancel->setText(QApplication::translate("Input_Dialog", "Cancel", 0));
        Project_Project_Name->setText(QApplication::translate("Input_Dialog", "Project Name:", 0));
        Project_Finished->setText(QApplication::translate("Input_Dialog", "Finished", 0));
        Project_Cancel->setText(QApplication::translate("Input_Dialog", "Cancel", 0));
        Item_Time_Label->setText(QApplication::translate("Input_Dialog", "Est. Time", 0));
        Item_Cost_Label->setText(QApplication::translate("Input_Dialog", "Est. Cost", 0));
        Item_Finish->setText(QApplication::translate("Input_Dialog", "Finished", 0));
        Item_Cancel->setText(QApplication::translate("Input_Dialog", "Cancel", 0));
        Timeout_label1->setText(QApplication::translate("Input_Dialog", "Do you need more time?(from main)", 0));
        Timeout_label_time->setText(QString());
        Timeout_button_yes->setText(QApplication::translate("Input_Dialog", "Yes", 0));
        Timeout2_label1->setText(QApplication::translate("Input_Dialog", "Do you need more time?(from local)", 0));
        Timeout2_label_time->setText(QString());
        Timeout2_button_yes->setText(QApplication::translate("Input_Dialog", "Yes", 0));
    } // retranslateUi
