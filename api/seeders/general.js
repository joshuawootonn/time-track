...
function employee(q){
  return q.bulkInsert('employee', [
    {id: '1', first_name: 'Joshua',last_name: 'Wootonn', pin: '565656', is_employed: "1", is_working: "0",authority_id: "3",crew_id: "1" },
    {id: '2', first_name: 'Jay',last_name: 'Simon', pin: '121212', is_employed: "1", is_working: "0",authority_id: "3",crew_id: "1" },
    {id: '3', first_name: 'Kurt',last_name: 'Simon', pin: '343434', is_employed: "1", is_working: "0",authority_id: "1",crew_id: "2" },
    {id: '4', first_name: 'Jon',last_name: 'Doe', pin: '878877', is_employed: "1", is_working: "0",authority_id: "2",crew_id: "3" }
  ])
}
...
function shift(q){
  ...
  return q.bulkInsert('shift', [
    {id: '1', clock_in: then, clock_out: now, length: length, employee_id: '1' },
    {id: '2', clock_in: then, clock_out: now, length: length, employee_id: '2' },
    {id: '3', clock_in: then, clock_out: now, length: length, employee_id: '3' },
    {id: '4', clock_in: then, clock_out: now, length: length, employee_id: '4' },
  ])
}
function task(q){
  return q.bulkInsert('task', [
    ...
    {id: '7', name: "Driver", numeric: "0", is_active: '1', subcategory_id: "5" },
    {id: '8', name: "Passenger", numeric: "0", is_active: '1', subcategory_id: "5" }
  ])
}

function projectTask(q){
  return q.bulkInsert('project_task', [
    {id: '1',task_id: "1", project_id: "1", quantity: '1000', estimate_time: '1000'},
    {id: '2',task_id: "2", project_id: "1", quantity: '2000', estimate_time: '5000'},
    {id: '3',task_id: "2", project_id: "2", quantity: '4400', estimate_time: '400'},
    {id: '4',task_id: "4", project_id: "3", quantity: '500', estimate_time: '2000'},
    {id: '5',task_id: "5", project_id: "3", quantity: '800', estimate_time: '2000'},
    {id: '6',task_id: "6", project_id: "3", quantity: '600', estimate_time: '200'},
    {id: '7',task_id: "7", project_id: "4", quantity: '1', estimate_time: '500'},
    {id: '8',task_id: "7", project_id: "4", quantity: '1', estimate_time: '100'},
  ])
}
