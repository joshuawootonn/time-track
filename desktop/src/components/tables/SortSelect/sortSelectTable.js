                    ...
                    >
                      ...
                      {headerData.map(ele => {
                        ...
                        if (type === TableDataTypes.NUMBER || type === TableDataTypes.BOOLEAN) {
                          ...
                          return <TableCell padding="dense" key={id} >{moment(n[id],'YYYY-MM-DDThh:mm:ss:SSS').format('MM/DD/YY')}</TableCell>;
                        } else if (type === TableDataTypes.DATETIME) {
                          return <TableCell padding="dense" key={id} >{moment(n[id],'YYYY-MM-DDThh:mm:ss:SSS').format('hh:mm a MM/DD')}</TableCell>;
