...
const psuedoShifts = [
  {
    clockInDate: `2018-11-10T06:26:57.000Z`,
    clockOutDate: `2018-11-10T06:26:57.000Z`,
    employeeId: 2,
    id: 1,
    length: 600,
    lunch: null,
  ...
  {
    clockInDate: `2018-11-09T13:30:00.000Z`,
    clockOutDate: `2018-11-09T20:34:00.000Z`,
    employeeId: 1,
    id: 4,
    length: 424,
    lunch: 30,
    activities: [
      { description: ``, id: 7, length: 390, projectTaskId: 1, shiftId: 4 }
    ],
    employee: {
      authorityId: 1,
      crewId: 1,
  ...
  {
    clockInDate: `2018-11-09T13:30:00.000Z`,
    clockOutDate: `2018-11-09T21:10:00.000Z`,
    employeeId: 2,
    id: 5,
    length: 460,
    lunch: 30,
    activities: [
      { description: ``, id: 8, length: 435, projectTaskId: 1, shiftId: 5 }
    ],
    employee: {
      authorityId: 1,
      crewId: 1,
  ...
  {
    clockInDate: `2018-11-09T13:30:00.000Z`,
    clockOutDate: `2018-11-09T21:12:00.000Z`,
    employeeId: 2,
    id: 6,
    length: 462,
    lunch: 30,
    activities: [
      { description: ``, id: 9, length: 435, projectTaskId: 1, shiftId: 6 }
    ],
    employee: {
      authorityId: 1,
      crewId: 1,
  ...
  {
    clockInDate: `2018-11-09T13:30:00.000Z`,
    clockOutDate: `2018-11-09T21:15:00.000Z`,
    employeeId: 2,
    id: 7,
    length: 465,
    lunch: 30,
    activities: [
      { description: ``, id: 13, length: 435, projectTaskId: 1, shiftId: 7 }
    ],
    employee: {
      authorityId: 1,
      crewId: 1,
  ...
  {
    clockInDate: `2018-11-09T13:30:00.000Z`,
    clockOutDate: `2018-11-09T21:50:00.000Z`,
    employeeId: 2,
    id: 8,
    length: 500,
    lunch: 30,
    activities: [
      { description: ``, id: 14, length: 465, projectTaskId: 2, shiftId: 8 }
    ],
    employee: {
      authorityId: 1,
      crewId: 1,
...
const props = {
  ...
  shifts: psuedoShifts,
  setStatus: jest.fn(),
  getAllProjects: jest.fn().mockImplementationOnce(() => Promise.resolve()),
  getAllEmployees: jest.fn().mockImplementationOnce(() => Promise.resolve()),
  getAllTasks: jest.fn().mockImplementationOnce(() => Promise.resolve()),
  getShiftsInRange: jest.fn().mockImplementationOnce(() => Promise.resolve())
};
