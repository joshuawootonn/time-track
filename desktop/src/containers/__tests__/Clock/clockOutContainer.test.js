...
import { EMPLOYEE_MOCK, PROJECT_MOCK, PROJECT_TASK_MOCK, COMPLETE_SHIFT_MOCK,PROJECT_TASK_OBJECT_MOCK } from 'constants/modelMocks';


const props =  {  
  currentShift:{ 
    clockInDate: moment.utc().subtract(7,`hours`).toString(),
    clockOutDate:null,
    employeeId:2,
    id:9,
    length:null,
