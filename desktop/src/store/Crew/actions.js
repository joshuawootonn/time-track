...
export const updateCrew = crew => {
  return async dispatch => {
    ...
    try {
      ...
      await dispatch(
        snackActions.openSnack(status.SUCCESS, `Crew Update Failed`)
      );
...
export const createCrew = crew => {
  return async dispatch => {
    ...
    try {
      ...
      await dispatch(
        snackActions.openSnack(status.SUCCESS, `Crew Creation Failed`)
      );
...
export const removeCrew = id => {
  return async dispatch => {
    ...
    try {
      ...
      await dispatch(
        snackActions.openSnack(status.SUCCESS, `Crew Deletion Failed`)
      );
