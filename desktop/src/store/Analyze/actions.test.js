...
describe(`Analyze Actions`, () => {
  ...
  test(`dispatch 1 action for select`, () => {
    ...
    compareActionTypesSync(
      expectedActionTypes,
      store,
      analyzeActions.setStatus(domains.EMPLOYEE, 1)
    );
  });
  test(`dispatch 1 action for editSettingModal`, () => {
    ...
    compareActionTypesSync(
      expectedActionTypes,
      store,
      analyzeActions.editSettingsModal()
    );
  });
  test(`dispatch 1 action for updateFilter`, () => {
    ...
    compareActionTypesSync(
      expectedActionTypes,
      store,
      analyzeActions.updateFilter(domains.EMPLOYEE, {})
    );
  });
  test(`dispatch 1 action for toggleFilter`, () => {
    ...
    compareActionTypesSync(
      expectedActionTypes,
      store,
      analyzeActions.toggleFilter(domains.EMPLOYEE)
    );
  });
  test(`dispatch 1 action for clearFilter`, () => {
    ...
    compareActionTypesSync(
      expectedActionTypes,
      store,
      analyzeActions.clearFilter(domains.EMPLOYEE)
    );
  });
});
