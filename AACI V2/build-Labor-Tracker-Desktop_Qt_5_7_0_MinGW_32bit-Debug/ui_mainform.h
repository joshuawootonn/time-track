...
public:
    ...
    void setupUi(QWidget *MainForm)
    {
        ...
        gridLayout_5->addWidget(ProjectView, 0, 0, 1, 1);
        ...
        ShiftWidget = new QTableWidget(ShiftTab);
        ShiftWidget->setObjectName(QStringLiteral("ShiftWidget"));
        ShiftWidget->setFrameShape(QFrame::NoFrame);

        gridLayout_3->addWidget(ShiftWidget, 0, 0, 1, 1);
        ...
        gridLayout_8->addWidget(EmployeeAdminStatus, 0, 1, 1, 1);

        EmployeeWage = new QCheckBox(groupBox_2);
        EmployeeWage->setObjectName(QStringLiteral("EmployeeWage"));

        gridLayout_8->addWidget(EmployeeWage, 1, 1, 1, 1);
        ...
        gridLayout_8->addWidget(EmployeePin, 1, 0, 1, 1);
        ...
        gridLayout_8->addWidget(EmployeeId, 0, 3, 1, 1);
        ...
        EmployeeName->raise();
        EmployeePin->raise();
        EmployeeAdminStatus->raise();
        EmployeeWage->raise();
        EmployeeShiftCount->raise();
        EmployeeActive->raise();
        EmployeeId->raise();
        EmployeeCurrent->raise();
        ...
        ProjectActive = new QCheckBox(groupBox_8);
        ProjectActive->setObjectName(QStringLiteral("ProjectActive"));

        gridLayout_9->addWidget(ProjectActive, 0, 1, 1, 1);
    ...
    void retranslateUi(QWidget *MainForm)
    {
        ...
        EmployeeWage->setText(QApplication::translate("MainForm", "Wage", 0));
        ...
        ProjectAdd->setText(QApplication::translate("MainForm", "Add", 0));
        ...
        ProjectActive->setText(QApplication::translate("MainForm", "Active", 0));
        ...
        ItemAdd->setText(QApplication::translate("MainForm", "Add", 0));
