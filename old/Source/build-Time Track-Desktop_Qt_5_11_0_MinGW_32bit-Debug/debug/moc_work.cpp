...
void Work::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Work::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Work::progress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Work::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Work::done)) {
                *result = 1;
                return;
            }
        }
