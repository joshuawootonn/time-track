...
#include "../../Time-Track/projecteditform.h"
...
void ProjectEditForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ProjectEditForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProjectEditForm::finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ProjectEditForm::staticMetaObject = {
